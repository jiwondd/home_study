...
# parameters=[{'n_estimators':[100,200,300],'learning_rate':[0.1,0.2,0.3,0.01],'max_depth':[None,2,3,4,5,6],'min_child_weight':[0,0.01,0.001,0.1,0.5,1]},
#              {'n_estimators':[100,200,300],'learning_rate':[0.1,0.2,0.3,0.01],'max_depth':[None,2,3,4,5,6],'min_child_weight':[0,0.01,0.001,0.1,0.5,1]},
#              {'n_estimators':[100,200,300],'learning_rate':[0.1,0.2,0.3,0.01],'max_depth':[None,2,3,4,5,6],'min_child_weight':[0,0.01,0.001,0.1,0.5,1],
